...
const LazyAbout = withLazyLoading(
  () => import("./components/About"),
  <SectionSkeleton height="h-96" />
)

const LazyProjects = withLazyLoading(
  () => import("./components/Projects"),
  <SectionSkeleton height="h-[600px]" />
)

const LazyTestimonials = withLazyLoading(
  () => import("./components/Testimonials"),
  <SectionSkeleton height="h-96" />
)

const LazyExperienceTimeline = withLazyLoading(
  () => import("./components/ExperienceTimeline"),
  <SectionSkeleton height="h-[800px]" />
)

const LazyCertifications = withLazyLoading(
...
const LazyFooter = withLazyLoading(
